...
import { X, User, Building2, MapPin, Mail, Phone, MessageSquare, Package, Calendar } from 'lucide-react';
                            ...
                            {submission.location && (
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-semibold text-navy">{submission.location}</div>
                                    </div>
                                </div>
                            )}
